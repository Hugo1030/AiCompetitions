...
--      => ycc_sales_caijun0313_feature_std_2m3m6m12m_div
--      1.计算标准差所需的平均值
--      2.计算标准差
--计算平均值
...
from prj_tc_231640_123409_4l0qvy.ycc_sales_caijun0313_feature_basewindow_div ;



--计算标准差
DROP TABLE IF EXISTS ycc_sales_caijun0313_feature_std_2m3m6m12m_div ;
CREATE TABLE ycc_sales_caijun0313_feature_std_2m3m6m12m_div
as
select sale_date,province_id,city_id,class_id,sale_quantity,
