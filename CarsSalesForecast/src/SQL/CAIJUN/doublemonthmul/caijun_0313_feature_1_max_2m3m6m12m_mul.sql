...
--      => stuff_ycc_sales_caijun0313_feature_max_2m3m6m12m_mul
...
,CASE 
     ...
     ELSE 1
 END AS 2sub1
from ycc_sales_caijun0313_feature_basewindow_mul) a;
...
DROP TABLE IF EXISTS stuff_ycc_sales_caijun0313_feature_max_2m3m6m12m_mul;
CREATE TABLE stuff_ycc_sales_caijun0313_feature_max_2m3m6m12m_mul 
AS
