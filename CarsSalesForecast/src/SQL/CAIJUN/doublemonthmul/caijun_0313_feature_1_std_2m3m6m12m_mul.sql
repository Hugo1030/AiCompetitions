...
--      => ycc_sales_caijun0313_feature_std_2m3m6m12m_mul
--      1.计算标准差所需的平均值
--      2.计算标准差
--计算平均值
...
--计算标准差
DROP TABLE IF EXISTS ycc_sales_caijun0313_feature_std_2m3m6m12m_mul ;
CREATE TABLE ycc_sales_caijun0313_feature_std_2m3m6m12m_mul
as
select sale_date,province_id,city_id,class_id,sale_quantity,
