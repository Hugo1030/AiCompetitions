...
from prj_tc_231640_123409_4l0qvy.ycc_sales_caijun0313_feature_basewindow_shift1M ;



--计算标准差
DROP TABLE IF EXISTS ycc_sales_caijun0313_feature_std_2m3m6m12m_shift1M ;
CREATE TABLE ycc_sales_caijun0313_feature_std_2m3m6m12m_shift1M
as
select sale_date,province_id,city_id,class_id,sale_quantity,
