...
,CASE 
     ...
     ELSE 1
 END AS 2sub1
from ycc_sales_caijun0313_feature_basewindow_shift1M) a;
...
DROP TABLE IF EXISTS stuff_ycc_sales_caijun0313_feature_min_2m3m6m12m_shift1M;
CREATE TABLE stuff_ycc_sales_caijun0313_feature_min_2m3m6m12m_shift1M 
AS
