...
-- 
-- 合并 one-hot 和 numerical 特征
DROP TABLE IF EXISTS ycc_sales_lichuan0303_feature_2_base_feautres;

CREATE TABLE ycc_sales_lichuan0303_feature_2_base_feautres
AS
SELECT ycc_sales_dama0303_feature_14_numerical.class_id, power_max, power_min, power_avg, car_length_max
...
LEFT OUTER JOIN ycc_sales_lichuan0303_feature_0_onehot
ON ycc_sales_dama0303_feature_14_numerical.class_id = ycc_sales_lichuan0303_feature_0_onehot.class_id;