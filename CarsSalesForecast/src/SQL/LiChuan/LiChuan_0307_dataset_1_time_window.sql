...
--    
-- 
DROP TABLE IF EXISTS ycc_sales_lichuan0307_traintest_1_time_window;

CREATE TABLE ycc_sales_lichuan0307_traintest_1_time_window
AS
...
FROM ycc_sales_lichuan0307_feature_16_produce_quantity a
LEFT OUTER JOIN ycc_sales_lichuan0307_feature_3_change_double b
ON a.class_id = b.class_id;

-- DROP TABLE IF EXISTS ycc_sales_lichuan0307_trainset_1_time_window;

-- CREATE TABLE ycc_sales_lichuan0307_trainset_1_time_window
-- AS
...
--  , sale_last2M_sum, sale_last3M_sum, sale_last6M_sum, sale_last12M_sum, sale_last2M_std
--  , sale_last3M_std, sale_last6M_std, sale_last12M_std, sale_last2M_avg, sale_last3M_avg
--  , sale_last6M_avg, sale_last12M_avg, lastyear_MoM
...
--  , department_id_2, department_id_3, department_id_4, department_id_5, tr_0
--  , tr_1, tr_1_2, tr_2, tr_4, tr_4_5
--  , tr_4_6, tr_5, tr_5_0, tr_5_4, tr_5_6
--  , tr_5_7, tr_6, tr_6_0, tr_6_7, tr_7
--  , tr_8, tr_8_0, tr_8_7, tr_9, gearbox_type_AMT
...
-- where year != 2.012 and year != 2.018 and sale_date != '201710' and sale_date != '201711' and sale_date != '201712';

-- DROP TABLE IF EXISTS ycc_sales_lichuan0307_testset_1_time_window;

-- CREATE TABLE ycc_sales_lichuan0307_testset_1_time_window
-- AS
-- select sale_date, province_id, city_id, class_id, sale_quantity
--  , oil_price, total_sale_last1M, total_last12M_sum, sale_last1M, sale_last12M
--  , cnt_classid, year, month, how_many_month_sale, purchase_tax
...
-- DROP TABLE IF EXISTS ycc_sales_lichuan0307_trainset_2_time_window;

-- CREATE TABLE ycc_sales_lichuan0307_trainset_2_time_window
-- AS
-- select sale_date, province_id, city_id, class_id, sale_quantity
--  , oil_price, total_sale_last1M, total_last12M_sum, sale_last1M, sale_last12M
--  , cnt_classid, year, month, how_many_month_sale, purchase_tax
...
--  , cylinder_number_5, cylinder_number_6, cylinder_number_8, cylinder_number_12
-- from ycc_sales_lichuan0307_traintest_1_time_window
-- where year != 2.012 and year != 2.018 and sale_date != '201301' and sale_date != '201711' and sale_date != '201712';

-- DROP TABLE IF EXISTS ycc_sales_lichuan0307_testset_2_time_window;

-- CREATE TABLE ycc_sales_lichuan0307_testset_2_time_window
-- AS
-- select sale_date, province_id, city_id, class_id, sale_quantity
--  , oil_price, total_sale_last1M, total_last12M_sum, sale_last1M, sale_last12M
--  , cnt_classid, year, month, how_many_month_sale, purchase_tax
...
-- DROP TABLE IF EXISTS ycc_sales_lichuan0307_trainset_3_time_window;

-- CREATE TABLE ycc_sales_lichuan0307_trainset_3_time_window
-- AS
-- select sale_date, province_id, city_id, class_id, sale_quantity
--  , oil_price, total_sale_last1M, total_last12M_sum, sale_last1M, sale_last12M
--  , cnt_classid, year, month, how_many_month_sale, purchase_tax
...
--  , cylinder_number_5, cylinder_number_6, cylinder_number_8, cylinder_number_12
-- from ycc_sales_lichuan0307_traintest_1_time_window
-- where year != 2.012 and year != 2.018 and sale_date != '201301' and sale_date != '201302' and sale_date != '201712';

-- DROP TABLE IF EXISTS ycc_sales_lichuan0307_testset_3_time_window;

-- CREATE TABLE ycc_sales_lichuan0307_testset_3_time_window
-- AS
-- select sale_date, province_id, city_id, class_id, sale_quantity
--  , oil_price, total_sale_last1M, total_last12M_sum, sale_last1M, sale_last12M
--  , cnt_classid, year, month, how_many_month_sale, purchase_tax
...
-- DROP TABLE IF EXISTS ycc_sales_lichuan0307_train_time_window;

-- CREATE TABLE ycc_sales_lichuan0307_train_time_window
-- AS
-- select sale_date, province_id, city_id, class_id, sale_quantity
--  , oil_price, total_sale_last1M, total_last12M_sum, sale_last1M, sale_last12M
--  , cnt_classid, year, month, how_many_month_sale, purchase_tax
...
--  , cylinder_number_5, cylinder_number_6, cylinder_number_8, cylinder_number_12
-- from ycc_sales_lichuan0307_traintest_1_time_window
-- where year != 2.012 and year != 2.018 and sale_date != '201301' and sale_date != '201302' and sale_date != '201303';

-- DROP TABLE IF EXISTS ycc_sales_lichuan0307_test_time_window;

CREATE TABLE ycc_sales_lichuan0307_test_time_window
AS
select sale_date, province_id, city_id, class_id, sale_quantity
    , produce_quantity_last1m, spring_festival , oil_price, total_sale_last1M, total_last12M_sum, sale_last1M, sale_last12M
    , cnt_classid, year, month, how_many_month_sale, purchase_tax
