...
--train1 : ycc_woody_0314_mock_B_strategy_three_add_0_out_1202_1710_train
PAI --GBDT回归
...
-DinputTableName="ycc_woody_0314_mock_B_strategy_three_add_0_1202_1710_train"
-DminLeafSampleCount="10"
-DsampleRatio="1"
-DmaxDepth="10"
-DmetricType="0"
-DmodelName="ycc_woody_0314_mock_B_strategy_three_add_0_out_1202_1710_model"
-DfeatureRatio="1"
...
--predict1: ycc_woody_0314_mock_B_strategy_three_add_0_out_1710_2013_test
PAI --预测测试集，注意每个PAI语句结束后的分号
-name prediction -project algo_public
-DdetailColName="prediction_detail"  --输出表中detail列名
-DmodelName="ycc_woody_0314_mock_B_strategy_three_add_0_out_1202_1710_model" --输入模型名称
...
-DoutputTableName="ycc_woody_0314_mock_B_strategy_three_add_0_out_1202_1710_predict" --输出表的名
-DscoreColName="prediction_score" --输出表中score列名
-DkvDelimiter=":" --当输入表数据为稀疏格式时，key和value的分割符
-DinputTableName="ycc_woody_0314_mock_B_strategy_three_add_1802_test" --输入的表名
...
--train2 : ycc_woody_0314_mock_B_strategy_three_add_0_out_1202_1712_train
PAI --GBDT回归
-name GBDT -project algo_public
-DfeatureSplitValueMaxSize="700"
-DlossType="3" --3-REGRESSION LOSS：mean squared error loss
...
-DmaxLeafCount="64"
-DlabelColName="sale_quantity"
-DinputTableName="ycc_woody_0314_mock_B_strategy_three_add_0_1202_1712_train"
-DminLeafSampleCount="10"
-DsampleRatio="1"
-DmaxDepth="10"
-DmetricType="0"
-DmodelName="ycc_woody_0314_mock_B_strategy_three_add_0_out_1202_1712_model"
-DfeatureRatio="1"
-Dp="1" --可选）指数底数。gbrank与regression loss中的指数底数,默认1如果p 1,将样本的label映身为p^label；当p <= 1时，不做映射，保持原来的label.范围1到5
-Dtau="0.6" --Tau参数。gbrank loss中的Tau参数，默认0.6，范围：[0,1]
-DtestRatio="0"
...
--predict2:ycc_woody_0314_mock_B_strategy_three_add_0_out_1711_2013_test
PAI --预测测试集，注意每个PAI语句结束后的分号
-name prediction -project algo_public
-DdetailColName="prediction_detail"  --输出表中detail列名
-DmodelName="ycc_woody_0314_mock_B_strategy_three_add_0_out_1202_1712_model" --输入模型名称
-DitemDelimiter="," --当输入表数据为稀疏格式时，kv间的分割符，这个和DkvDelimiter有什么区别？
-DresultColName="prediction_result" --输出表result列名称
-Dlifecycle="28" --指定输出表的生命周期，应该是28天吧
-DoutputTableName="ycc_woody_0314_mock_B_strategy_three_add_0_out_1202_1712_predict" --输出表的名
-DscoreColName="prediction_score" --输出表中score列名
-DkvDelimiter=":" --当输入表数据为稀疏格式时，key和value的分割符
-DinputTableName="ycc_woody_0314_mock_B_strategy_three_add_1802_test" --输入的表名
-DenableSparse="false" --输入表是否为稀疏格式
...
--train3 : ycc_woody_0314_mock_B_strategy_three_add_0_out_1302_1710_train
PAI --GBDT回归
-name GBDT -project algo_public
-DfeatureSplitValueMaxSize="700"
-DlossType="3" --3-REGRESSION LOSS：mean squared error loss
...
-DmaxLeafCount="64"
-DlabelColName="sale_quantity"
-DinputTableName="ycc_woody_0314_mock_B_strategy_three_add_0_1302_1710_train"
-DminLeafSampleCount="10"
-DsampleRatio="1"
-DmaxDepth="10"
-DmetricType="0"
-DmodelName="ycc_woody_0314_mock_B_strategy_three_add_0_out_1302_1710_model"
-DfeatureRatio="1"
-Dp="1" --可选）指数底数。gbrank与regression loss中的指数底数,默认1如果p 1,将样本的label映身为p^label；当p <= 1时，不做映射，保持原来的label.范围1到5
-Dtau="0.6" --Tau参数。gbrank loss中的Tau参数，默认0.6，范围：[0,1]
-DtestRatio="0"
...
--predict3: ycc_woody_0314_mock_B_strategy_three_add_0_out_1710_2013_test
PAI --预测测试集，注意每个PAI语句结束后的分号
-name prediction -project algo_public
-DdetailColName="prediction_detail"  --输出表中detail列名
-DmodelName="ycc_woody_0314_mock_B_strategy_three_add_0_out_1302_1710_model" --输入模型名称
-DitemDelimiter="," --当输入表数据为稀疏格式时，kv间的分割符，这个和DkvDelimiter有什么区别？
-DresultColName="prediction_result" --输出表result列名称
-Dlifecycle="28" --指定输出表的生命周期，应该是28天吧
-DoutputTableName="ycc_woody_0314_mock_B_strategy_three_add_0_out_1302_1710_predict" --输出表的名
-DscoreColName="prediction_score" --输出表中score列名
-DkvDelimiter=":" --当输入表数据为稀疏格式时，key和value的分割符
-DinputTableName="ycc_woody_0314_mock_B_strategy_three_add_1802_test" --输入的表名
-DenableSparse="false" --输入表是否为稀疏格式
...
--train4 : ycc_woody_0314_mock_B_strategy_three_add_0_out_1302_1712_train
PAI --GBDT回归
-name GBDT -project algo_public
-DfeatureSplitValueMaxSize="700"
-DlossType="3" --3-REGRESSION LOSS：mean squared error loss
...
-DmaxLeafCount="64"
-DlabelColName="sale_quantity"
-DinputTableName="ycc_woody_0314_mock_B_strategy_three_add_0_1302_1712_train"
-DminLeafSampleCount="10"
-DsampleRatio="1"
-DmaxDepth="10"
-DmetricType="0"
-DmodelName="ycc_woody_0314_mock_B_strategy_three_add_0_out_1302_1712_model"
-DfeatureRatio="1"
-Dp="1" --可选）指数底数。gbrank与regression loss中的指数底数,默认1如果p 1,将样本的label映身为p^label；当p <= 1时，不做映射，保持原来的label.范围1到5
-Dtau="0.6" --Tau参数。gbrank loss中的Tau参数，默认0.6，范围：[0,1]
-DtestRatio="0"
...
--predict4:ycc_woody_0314_mock_B_strategy_three_add_0_out_1711_2013_test
PAI --预测测试集，注意每个PAI语句结束后的分号
-name prediction -project algo_public
-DdetailColName="prediction_detail"  --输出表中detail列名
-DmodelName="ycc_woody_0314_mock_B_strategy_three_add_0_out_1302_1712_model" --输入模型名称
-DitemDelimiter="," --当输入表数据为稀疏格式时，kv间的分割符，这个和DkvDelimiter有什么区别？
-DresultColName="prediction_result" --输出表result列名称
-Dlifecycle="28" --指定输出表的生命周期，应该是28天吧
-DoutputTableName="ycc_woody_0314_mock_B_strategy_three_add_0_out_1302_1712_predict" --输出表的名
-DscoreColName="prediction_score" --输出表中score列名
-DkvDelimiter=":" --当输入表数据为稀疏格式时，key和value的分割符
-DinputTableName="ycc_woody_0314_mock_B_strategy_three_add_1802_test" --输入的表名
-DenableSparse="false" --输入表是否为稀疏格式
