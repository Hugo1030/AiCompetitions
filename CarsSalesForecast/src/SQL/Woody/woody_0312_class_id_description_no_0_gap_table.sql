...
--从12年开始，不要13年
create table if not exists stuff_woody_0311_include_produce_quantity_no13_1201_1709_train
as select * from stuff_woody_0311_include_produce_quantity
where (sale_date not in (201801,201712,201711,201710,201301,201302,201303,201304,201305,201306,201307,201308,201309,201310,201311,201312));
create table if not exists stuff_woody_0311_include_produce_quantity_no13_1202_1710_train
as select * from stuff_woody_0311_include_produce_quantity
where (sale_date not in (201801,201712,201711,201201,201301,201302,201303,201304,201305,201306,201307,201308,201309,201310,201311,201312));
create table if not exists stuff_woody_0311_include_produce_quantity_no13_1203_1711_train
as select * from stuff_woody_0311_include_produce_quantity
where (sale_date not in (201801,201712,201202,201201,201301,201302,201303,201304,201305,201306,201307,201308,201309,201310,201311,201312));
create table if not exists stuff_woody_0311_include_produce_quantity_no13_1201_1712_train
as select * from stuff_woody_0311_include_produce_quantity
where (sale_date not in (201801,201301,201302,201303,201304,201305,201306,201307,201308,201309,201310,201311,201312));
