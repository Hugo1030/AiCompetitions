--训练生成的模型
drop offlinemodel if exists stuff_woody_0310_max_min_window_output_1301_1709_model;
drop offlinemodel if exists stuff_woody_0310_max_min_window_output_1302_1710_model;
drop offlinemodel if exists stuff_woody_0310_max_min_window_output_1303_1711_model;
drop offlinemodel if exists stuff_woody_0310_max_min_window_output_1301_1712_model;

-- 预测测试集产生的临时表
drop table if exists stuff_woody_0310_max_min_window_output_1710_2013_predict;
drop table if exists stuff_woody_0310_max_min_window_output_1711_2013_predict;
drop table if exists stuff_woody_0310_max_min_window_output_1712_2013_predict;

--预测最终结果集产生的临时表
drop table if exists stuff_woody_0310_max_min_window_output_1301_1712_model_yc_result_submit_a;
drop table if exists stuff_woody_0310_max_min_window_output_1302_1710_model_yc_result_submit_a;
drop table if exists stuff_woody_0310_max_min_window_output_1303_1711_model_yc_result_submit_a;




--train1 : stuff_woody_0310_max_min_window_output_1301_1709_train
PAI --GBDT回归
...
-DmaxDepth="10"
-DmetricType="0"
-DmodelName="stuff_woody_0310_max_min_window_output_1301_1709_model"
-DfeatureRatio="1"
...
-DoutputTableName="stuff_woody_0310_max_min_window_output_1710_2013_predict" --输出表的名
...
--estimate1:stuff_woody_0310_max_min_window_output_1710_2013_predict
--回归评估
select sqrt(sum(pow(a.prediction_result-b.sale_quantity,2))/count(a.prediction_result)) as rmsle from
stuff_woody_0310_max_min_window_output_1710_2013_predict a
...
--train2 : stuff_woody_0310_max_min_window_output_1302_1710_train
PAI --GBDT回归
-name GBDT -project algo_public
-DfeatureSplitValueMaxSize="700"
-DlossType="3" --3-REGRESSION LOSS：mean squared error loss
...
-DmaxDepth="10"
-DmetricType="0"
-DmodelName="stuff_woody_0310_max_min_window_output_1302_1710_model"
-DfeatureRatio="1"
-Dp="1" --可选）指数底数。gbrank与regression loss中的指数底数,默认1如果p 1,将样本的label映身为p^label；当p <= 1时，不做映射，保持原来的label.范围1到5
-Dtau="0.6" --Tau参数。gbrank loss中的Tau参数，默认0.6，范围：[0,1]
-DtestRatio="0"
...
--predict2:stuff_woody_0310_max_min_window_output_1711_2013_test
PAI --预测测试集，注意每个PAI语句结束后的分号
-name prediction -project algo_public
-DdetailColName="prediction_detail"  --输出表中detail列名
-DmodelName="stuff_woody_0310_max_min_window_output_1302_1710_model" --输入模型名称
-DitemDelimiter="," --当输入表数据为稀疏格式时，kv间的分割符，这个和DkvDelimiter有什么区别？
-DresultColName="prediction_result" --输出表result列名称
-Dlifecycle="28" --指定输出表的生命周期，应该是28天吧
-DoutputTableName="stuff_woody_0310_max_min_window_output_1711_2013_predict" --输出表的名
-DscoreColName="prediction_score" --输出表中score列名
-DkvDelimiter=":" --当输入表数据为稀疏格式时，key和value的分割符
...
--estimate2:stuff_woody_0310_max_min_window_output_1711_2013_predict
--回归评估
select sqrt(sum(pow(a.prediction_result-b.sale_quantity,2))/count(a.prediction_result)) as rmsle from
stuff_woody_0310_max_min_window_output_1711_2013_predict a
left outer join  stuff_woody_0310_max_min_window_1711_test b
on a.city_id = b.city_id and a.class_id = b.class_id and a.sale_date=b.sale_date ;

--train3 :stuff_woody_0310_max_min_window_output_1303_1711_train
PAI --GBDT回归
-name GBDT -project algo_public
-DfeatureSplitValueMaxSize="700"
-DlossType="3" --3-REGRESSION LOSS：mean squared error loss
...
-DmaxDepth="10"
-DmetricType="0"
-DmodelName="stuff_woody_0310_max_min_window_output_1303_1711_model"
-DfeatureRatio="1"
-Dp="1" --可选）指数底数。gbrank与regression loss中的指数底数,默认1如果p 1,将样本的label映身为p^label；当p <= 1时，不做映射，保持原来的label.范围1到5
-Dtau="0.6" --Tau参数。gbrank loss中的Tau参数，默认0.6，范围：[0,1]
-DtestRatio="0"
...
--predict3:stuff_woody_0310_max_min_window_output_1712_2013_test
PAI --预测测试集，注意每个PAI语句结束后的分号
-name prediction -project algo_public
-DdetailColName="prediction_detail"  --输出表中detail列名
-DmodelName="stuff_woody_0310_max_min_window_output_1303_1711_model" --输入模型名称
-DitemDelimiter="," --当输入表数据为稀疏格式时，kv间的分割符，这个和DkvDelimiter有什么区别？
-DresultColName="prediction_result" --输出表result列名称
-Dlifecycle="28" --指定输出表的生命周期，应该是28天吧
-DoutputTableName="stuff_woody_0310_max_min_window_output_1712_2013_predict" --输出表的名
-DscoreColName="prediction_score" --输出表中score列名
-DkvDelimiter=":" --当输入表数据为稀疏格式时，key和value的分割符
...
--estimate3:stuff_woody_0310_max_min_window_output_1712_2013_predict
--回归评估
select sqrt(sum(pow(a.prediction_result-b.sale_quantity,2))/count(a.prediction_result)) as rmsle from
stuff_woody_0310_max_min_window_output_1712_2013_predict a
left outer join  stuff_woody_0310_max_min_window_1712_test b
on a.city_id = b.city_id and a.class_id = b.class_id and a.sale_date=b.sale_date ;



--train4 : stuff_woody_0310_max_min_window_output_1301_1712_train
PAI --GBDT回归
-name GBDT -project algo_public
-DfeatureSplitValueMaxSize="700"
-DlossType="3" --3-REGRESSION LOSS：mean squared error loss
...
-DmaxDepth="10"
-DmetricType="0"
-DmodelName="stuff_woody_0310_max_min_window_output_1301_1712_model"
-DfeatureRatio="1"
-Dp="1" --可选）指数底数。gbrank与regression loss中的指数底数,默认1如果p 1,将样本的label映身为p^label；当p <= 1时，不做映射，保持原来的label.范围1到5
-Dtau="0.6" --Tau参数。gbrank loss中的Tau参数，默认0.6，范围：[0,1]
-DtestRatio="0"
...
--------------------------------以下部分为预测201801数据--------------------------------------------
--predict_201801_1:stuff_woody_0310_max_min_window_output_1301_1712_model

PAI --预测最终结果
-name prediction -project algo_public
-DdetailColName="prediction_detail"  --输出表中detail列名
-DmodelName="stuff_woody_0310_max_min_window_output_1301_1712_model" --输入模型名称
-DitemDelimiter="," --当输入表数据为稀疏格式时，kv间的分割符，这个和DkvDelimiter有什么区别？
-DresultColName="sale_quantity" --输出表result列名称
-Dlifecycle="28" --指定输出表的生命周期，应该是28天吧
-DoutputTableName="stuff_woody_0310_max_min_window_output_1301_1712_model_yc_result_submit_a" --输出表的名
-DscoreColName="prediction_score" --输出表中score列名
-DkvDelimiter=":" --当输入表数据为稀疏格式时，key和value的分割符
...
--predict_201801_2:stuff_woody_0310_max_min_window_output_1302_1710_model
PAI --预测最终结果
-name prediction -project algo_public
-DdetailColName="prediction_detail"  --输出表中detail列名
-DmodelName="stuff_woody_0310_max_min_window_output_1302_1710_model" --输入模型名称
...
-DresultColName="sale_quantity" --输出表result列名称
-Dlifecycle="28" --指定输出表的生命周期，应该是28天吧
-DoutputTableName="stuff_woody_0310_max_min_window_output_1302_1710_model_yc_result_submit_a" --输出表的名
-DscoreColName="prediction_score" --输出表中score列名
-DkvDelimiter=":" --当输入表数据为稀疏格式时，key和value的分割符
-DinputTableName="stuff_woody_0310_max_min_window_1801_predict" --输入的表名
-DenableSparse="false" --输入表是否为稀疏格式
...
--predict_201801_3:stuff_woody_0310_max_min_window_output_1303_1711_model
PAI --预测最终结果
-name prediction -project algo_public
-DdetailColName="prediction_detail"  --输出表中detail列名
-DmodelName="stuff_woody_0310_max_min_window_output_1303_1711_model" --输入模型名称
...
-DresultColName="sale_quantity" --输出表result列名称
-Dlifecycle="28" --指定输出表的生命周期，应该是28天吧
-DoutputTableName="stuff_woody_0310_max_min_window_output_1303_1711_model_yc_result_submit_a" --输出表的名
-DscoreColName="prediction_score" --输出表中score列名
-DkvDelimiter=":" --当输入表数据为稀疏格式时，key和value的分割符
-DinputTableName="stuff_woody_0310_max_min_window_1801_predict" --输入的表名
-DenableSparse="false" --输入表是否为稀疏格式
...
FROM (SELECT sale_date, province_id, city_id, class_id, sale_quantity FROM stuff_woody_0310_max_min_window_output_1301_1712_model_yc_result_submit_a) a
JOIN
(SELECT sale_date, province_id, city_id, class_id, sale_quantity FROM stuff_woody_0310_max_min_window_output_1302_1710_model_yc_result_submit_a) b
...
JOIN
(SELECT sale_date, province_id, city_id, class_id, sale_quantity FROM stuff_woody_0310_max_min_window_output_1303_1711_model_yc_result_submit_a) b
ON( a.province_id=b.province_id and a.city_id=b.city_id and a.class_id=b.class_id);
