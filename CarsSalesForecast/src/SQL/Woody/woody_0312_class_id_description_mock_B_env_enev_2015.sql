...
--train1 : stuff_woody_0312_mock_B_env_enev_out_1202_1410_train
PAI --GBDT回归
...
-DinputTableName="stuff_woody_0312_mock_B_env_enev_1202_1410_train"
-DminLeafSampleCount="10"
-DsampleRatio="1"
-DmaxDepth="10"
-DmetricType="0"
-DmodelName="stuff_woody_0312_mock_B_env_enev_out_1202_1410_model"
-DfeatureRatio="1"
...
--predict1: stuff_woody_0312_mock_B_env_enev_out_1710_2013_test
PAI --预测测试集，注意每个PAI语句结束后的分号
-name prediction -project algo_public
-DdetailColName="prediction_detail"  --输出表中detail列名
-DmodelName="stuff_woody_0312_mock_B_env_enev_out_1202_1410_model" --输入模型名称
...
-DoutputTableName="stuff_woody_0312_mock_B_env_enev_out_1202_1410_predict" --输出表的名
-DscoreColName="prediction_score" --输出表中score列名
-DkvDelimiter=":" --当输入表数据为稀疏格式时，key和value的分割符
-DinputTableName="stuff_woody_0312_mock_B_env_1502_test" --输入的表名
...
--estimate1:stuff_woody_0312_mock_B_env_enev_out_1202_1410_predict
--回归评估
select sqrt(sum(pow(a.prediction_result-b.sale_quantity,2))/count(a.prediction_result)) as rmsle from
stuff_woody_0312_mock_B_env_enev_out_1202_1410_predict a
left outer join  stuff_woody_0312_mock_B_env_1502_test b
on a.city_id = b.city_id and a.class_id = b.class_id and a.sale_date=b.sale_date ;

--train2 : stuff_woody_0312_mock_B_env_enev_out_1204_1412_train
PAI --GBDT回归
-name GBDT -project algo_public
-DfeatureSplitValueMaxSize="700"
-DlossType="3" --3-REGRESSION LOSS：mean squared error loss
...
-DmaxLeafCount="64"
-DlabelColName="sale_quantity"
-DinputTableName="stuff_woody_0312_mock_B_env_enev_1204_1412_train"
-DminLeafSampleCount="10"
-DsampleRatio="1"
-DmaxDepth="10"
-DmetricType="0"
-DmodelName="stuff_woody_0312_mock_B_env_enev_out_1204_1412_model"
-DfeatureRatio="1"
-Dp="1" --可选）指数底数。gbrank与regression loss中的指数底数,默认1如果p 1,将样本的label映身为p^label；当p <= 1时，不做映射，保持原来的label.范围1到5
-Dtau="0.6" --Tau参数。gbrank loss中的Tau参数，默认0.6，范围：[0,1]
-DtestRatio="0"
...
--predict2:stuff_woody_0312_mock_B_env_enev_out_1711_2013_test
PAI --预测测试集，注意每个PAI语句结束后的分号
-name prediction -project algo_public
-DdetailColName="prediction_detail"  --输出表中detail列名
-DmodelName="stuff_woody_0312_mock_B_env_enev_out_1204_1412_model" --输入模型名称
-DitemDelimiter="," --当输入表数据为稀疏格式时，kv间的分割符，这个和DkvDelimiter有什么区别？
-DresultColName="prediction_result" --输出表result列名称
-Dlifecycle="28" --指定输出表的生命周期，应该是28天吧
-DoutputTableName="stuff_woody_0312_mock_B_env_enev_out_1204_1412_predict" --输出表的名
-DscoreColName="prediction_score" --输出表中score列名
-DkvDelimiter=":" --当输入表数据为稀疏格式时，key和value的分割符
-DinputTableName="stuff_woody_0312_mock_B_env_1502_test" --输入的表名
-DenableSparse="false" --输入表是否为稀疏格式
...
--estimate2:stuff_woody_0312_mock_B_env_enev_out_1204_1412_predict
--回归评估
select sqrt(sum(pow(a.prediction_result-b.sale_quantity,2))/count(a.prediction_result)) as rmsle from
stuff_woody_0312_mock_B_env_enev_out_1204_1412_predict a
left outer join  stuff_woody_0312_mock_B_env_1502_test b
on a.city_id = b.city_id and a.class_id = b.class_id and a.sale_date=b.sale_date ;

--train3 : stuff_woody_0312_mock_B_env_enev_out_1302_1410_train
PAI --GBDT回归
-name GBDT -project algo_public
-DfeatureSplitValueMaxSize="700"
-DlossType="3" --3-REGRESSION LOSS：mean squared error loss
...
-DmaxLeafCount="64"
-DlabelColName="sale_quantity"
-DinputTableName="stuff_woody_0312_mock_B_env_enev_1302_1410_train"
-DminLeafSampleCount="10"
-DsampleRatio="1"
-DmaxDepth="10"
-DmetricType="0"
-DmodelName="stuff_woody_0312_mock_B_env_enev_out_1302_1410_model"
-DfeatureRatio="1"
-Dp="1" --可选）指数底数。gbrank与regression loss中的指数底数,默认1如果p 1,将样本的label映身为p^label；当p <= 1时，不做映射，保持原来的label.范围1到5
-Dtau="0.6" --Tau参数。gbrank loss中的Tau参数，默认0.6，范围：[0,1]
-DtestRatio="0"
...
--predict3: stuff_woody_0312_mock_B_env_enev_out_1710_2013_test
PAI --预测测试集，注意每个PAI语句结束后的分号
-name prediction -project algo_public
-DdetailColName="prediction_detail"  --输出表中detail列名
-DmodelName="stuff_woody_0312_mock_B_env_enev_out_1302_1410_model" --输入模型名称
-DitemDelimiter="," --当输入表数据为稀疏格式时，kv间的分割符，这个和DkvDelimiter有什么区别？
-DresultColName="prediction_result" --输出表result列名称
-Dlifecycle="28" --指定输出表的生命周期，应该是28天吧
-DoutputTableName="stuff_woody_0312_mock_B_env_enev_out_1302_1410_predict" --输出表的名
-DscoreColName="prediction_score" --输出表中score列名
-DkvDelimiter=":" --当输入表数据为稀疏格式时，key和value的分割符
-DinputTableName="stuff_woody_0312_mock_B_env_1502_test" --输入的表名
-DenableSparse="false" --输入表是否为稀疏格式
...
--estimate3:stuff_woody_0312_mock_B_env_enev_out_1302_1410_predict
--回归评估
select sqrt(sum(pow(a.prediction_result-b.sale_quantity,2))/count(a.prediction_result)) as rmsle from
stuff_woody_0312_mock_B_env_enev_out_1302_1410_predict a
left outer join  stuff_woody_0312_mock_B_env_1502_test b
on a.city_id = b.city_id and a.class_id = b.class_id and a.sale_date=b.sale_date ;
...
--train4 : stuff_woody_0312_mock_B_env_enev_out_1304_1412_train
PAI --GBDT回归
-name GBDT -project algo_public
-DfeatureSplitValueMaxSize="700"
-DlossType="3" --3-REGRESSION LOSS：mean squared error loss
...
-DmaxLeafCount="64"
-DlabelColName="sale_quantity"
-DinputTableName="stuff_woody_0312_mock_B_env_enev_1304_1412_train"
-DminLeafSampleCount="10"
-DsampleRatio="1"
-DmaxDepth="10"
-DmetricType="0"
-DmodelName="stuff_woody_0312_mock_B_env_enev_out_1304_1412_model"
-DfeatureRatio="1"
-Dp="1" --可选）指数底数。gbrank与regression loss中的指数底数,默认1如果p 1,将样本的label映身为p^label；当p <= 1时，不做映射，保持原来的label.范围1到5
-Dtau="0.6" --Tau参数。gbrank loss中的Tau参数，默认0.6，范围：[0,1]
-DtestRatio="0"
...
--predict4:stuff_woody_0312_mock_B_env_enev_out_1711_2013_test
PAI --预测测试集，注意每个PAI语句结束后的分号
-name prediction -project algo_public
-DdetailColName="prediction_detail"  --输出表中detail列名
-DmodelName="stuff_woody_0312_mock_B_env_enev_out_1304_1412_model" --输入模型名称
-DitemDelimiter="," --当输入表数据为稀疏格式时，kv间的分割符，这个和DkvDelimiter有什么区别？
-DresultColName="prediction_result" --输出表result列名称
-Dlifecycle="28" --指定输出表的生命周期，应该是28天吧
-DoutputTableName="stuff_woody_0312_mock_B_env_enev_out_1304_1412_predict" --输出表的名
-DscoreColName="prediction_score" --输出表中score列名
-DkvDelimiter=":" --当输入表数据为稀疏格式时，key和value的分割符
-DinputTableName="stuff_woody_0312_mock_B_env_1502_test" --输入的表名
-DenableSparse="false" --输入表是否为稀疏格式
...
--estimate4:stuff_woody_0312_mock_B_env_enev_out_1304_1412_predict
--回归评估
select sqrt(sum(pow(a.prediction_result-b.sale_quantity,2))/count(a.prediction_result)) as rmsle from
stuff_woody_0312_mock_B_env_enev_out_1304_1412_predict a
left outer join  stuff_woody_0312_mock_B_env_1502_test b
on a.city_id = b.city_id and a.class_id = b.class_id and a.sale_date=b.sale_date ;
